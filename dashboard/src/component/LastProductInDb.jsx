...
export const LastProductInDb = () => {
  ...
  return (
    ...
    <img src={detailProductData.data.images[0]} className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{width: "40rem"}} alt="Product" />
   
              </div>
              <h2>${(detailProductData.data.discount !== 0) ? (detailProductData.data.discount-(detailProductData.data.price*detailProductData.data.discount/100)) :  detailProductData.data.price}</h2>
              <p>{lastProduct.description}</p>
           
              <a className="btn btn-danger" rel="nofollow" href={lastProduct.detail}>
